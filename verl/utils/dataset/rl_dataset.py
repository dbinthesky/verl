...
class RLHFDataset(Dataset):
    ...
    def _download(self, use_origin_parquet=False):
        ...
        print("[DEBUG]", self.data_files, use_origin_parquet, self.original_data_files)
        ...
        if self.filter_overlong_prompts:
            ...
            if processor is not None:
                ...
                def doc2len(doc) -> int:
                    ...
                    images = [process_image(image) for image in messages.pop(
                        image_key)] if image_key in messages else None
                    videos = [process_video(video) for video in messages.pop(
