...
setup_path() {
    ...
    VERL_DIR="${HOME}/verl"
    # ACTOR_MODEL_PATH="/mnt/shared-storage-user/songdemin/user/tongjian/ckpts/datareview_sft_test/Qwen_30B_A3_instruct_fabricate_qa_self_taught_250829_sft_doc2query_v3_if_enhance_0914/20250914222529/hf-88" 
    ACTOR_MODEL_PATH="/mnt/shared-storage-user/ailab-hx/tongjian/ckpts/datareview_rl_test/verl/grpo/archived/doc2query_v3_30b_a3_2025-09-17_roll16_128_dapo_kl_coef_0_wo_entropy_t1.0_solver_dsv3_step_150"
    BASE_MODEL_PATH=$ACTOR_MODEL_PATH
    TRAIN_DATA='["/mnt/shared-storage-user/ailab-hx/tongjian/rl/doc2query_v3/pdf_doc2query_260114_inputs_train.parquet"]'
    VAL_DATA="/mnt/shared-storage-user/ailab-hx/tongjian/rl/doc2query_v3/pdf_doc2query_260114_inputs_train.parquet"

    # experiment_name="doc2query_v3_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_kl_coef_${KL_LOSS_COEF}_t${TEMPERATURE}"
    experiment_name="doc2query_v3_2026-01-11-12_roll8_64_kl_coef_0_t1.0"
    # experiment_name="doc2query_v3_2026-01-28-01_roll24_32_kl_coef_0_t1.0"
    project_name="doc2query_v3"

    OUTPUT_DIR="/mnt/shared-storage-user/songdemin/user/tongjian/ckpts/datareview_rl_test/verl/grpo/doc2query_v3/${experiment_name}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
