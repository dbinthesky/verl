...
WORKER_MEMORY="${WORKER_MEMORY:-"900"}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/doc2query_st/dapo_qwen2_5-7b_doc2query_st.sh"
