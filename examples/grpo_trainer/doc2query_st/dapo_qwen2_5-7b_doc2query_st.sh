...
setup_path() {
    ...
    experiment_name="doc2query_st_7b_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_dapo_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}"
    project_name="doc2query_st"
    
    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/doc2query_st/${experiment_name}/"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
