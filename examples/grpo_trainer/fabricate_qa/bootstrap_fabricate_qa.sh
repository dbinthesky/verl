...
JOB_NAME="internlm3-8b_qwq_fabricate_qa_gpqa"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/fabricate_qa/run_qwen2_5-7b_qwq_fabricate_qa_0330_late_stage_gpqa.sh"
