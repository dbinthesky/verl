...
setup_path() {
    ...
    experiment_name="qwen2_5-7b_qwq_fabricate_qa_criteria-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_qwq_fabricate_qa_criteria"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/qwen2_5-7b_qwq_fabricate_qa_criteria/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
