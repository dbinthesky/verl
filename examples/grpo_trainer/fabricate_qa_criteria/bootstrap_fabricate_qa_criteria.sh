...
JOB_NAME="qwen2_5-7b_qwq_fabricate_qa_criteria"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/fabricate_qa_criteria/run_qwen2_5-7b_qwq_criteria.sh"
