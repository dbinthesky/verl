...
JOB_NAME="qwen2_5-7b_qwq_pretrain_bt"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/pretrain_bt/run_qwen2_5-7b_qwq_pretrain_bt.sh"
