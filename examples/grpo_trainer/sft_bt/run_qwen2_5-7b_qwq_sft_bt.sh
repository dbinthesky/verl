...
setup_path() {
    ...
    TRAIN_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/sft_bt/internlm2_5_s2_release_8k_train"
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/sft_bt/internlm3_s2_release_0213_8k_sample100_test"

    experiment_name="qwen2_5-7b_sft_bt-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_qwq_sft_bt"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/qwen2_5-7b_qwq_sft_bt/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        custom_reward_function.name=qwq_longcot_sft_back_translation_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/rm_w_criteria.py" \
        +custom_valid_reward_function.name=qwq_longcot_sft_back_translation_compute_score_valid \
