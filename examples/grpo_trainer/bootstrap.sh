...
JOB_NAME="IDLE_TASK_KILL_IF_NEED_verl-grpo-internlm3-8b_instruct_2024_0321_train_bsz32"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/run_internlm3-8b_instruct_bsz32_0321.sh"
