...
JOB_NAME="ds-r1-distill-qwen-7b_pretrain_refine_question"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/pretrain_refine/run_ds-r1-distill-qwen-7b_pretrain_refine_question.sh"
