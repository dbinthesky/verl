...
JOB_NAME="internlm_3-8b_pretrain_cot_enhance"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/pretrain_refine/run_internlm_3-8b_cot_enhance.sh"
