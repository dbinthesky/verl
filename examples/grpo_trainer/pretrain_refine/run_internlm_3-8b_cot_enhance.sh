...
setup_path() {
    ...
    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/internlm_3-8b_pretrain_cot_enhance/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        custom_reward_function.name=cot_enhance_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/pt_refine.py" \
        +custom_valid_reward_function.name=cot_enhance_compute_score_valid \
