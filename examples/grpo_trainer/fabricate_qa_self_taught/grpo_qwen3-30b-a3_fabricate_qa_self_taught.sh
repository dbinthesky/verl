...
setup_path() {
    ...
    TRAIN_DATA='["/mnt/shared-storage-user/ailab-hx/tongjian/rl/fabricate_qa_self_taught/fabricate_qa_self_taught_cot_rl_input_train/index0.parquet","/mnt/shared-storage-user/ailab-hx/tongjian/rl/fabricate_qa_self_taught/fabricate_qa_self_taught_cot_rl_input_train/index1.parquet"]' 
    VAL_DATA="/mnt/shared-storage-user/ailab-hx/tongjian/rl/fabricate_qa_self_taught/fabricate_qa_self_taught_cot_rl_input_test.parquet"

    experiment_name="fabricate_qa_st_30b_a3_think_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}_agg-loss-token-mean"
    project_name="fabricate_qa_st"

    OUTPUT_DIR="/mnt/shared-storage-user/ailab-hx/tongjian/ckpts/datareview_rl_test/verl/grpo/fabricate_qa_self_taught/${experiment_name}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        custom_reward_function.name=doc2query_self_taught_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/self_taught.py" \
        +custom_valid_reward_function.name=doc2query_self_taught_compute_score_valid \
