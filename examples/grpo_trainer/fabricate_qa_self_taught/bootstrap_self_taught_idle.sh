...
JOB_NAME="fabricate_self_taught"
...
CHARGE_GROUP="hx_gpu"
RUN_CMD="/mnt/shared-storage-user/ailab-hx/tongjian/verl/examples/grpo_trainer/fabricate_qa_self_taught/grpo_qwen3-30b-a3_fabricate_qa_self_taught.sh"
