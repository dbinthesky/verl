...
setup_path() {
    ...
    BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/tongjian/ckpts/Qwen25-7B-hard_case_mixed_v0_0_1_aug_v1_6w"
    ...
    experiment_name="qwen25-7b_distill_qwq-dlc-${YYMMDD}-${HHMMSS}"
