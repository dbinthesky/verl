...
setup_path() {
    ...
    BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/archived/distillv16_s1_roll16_bsz32_grpo_w_kl_coef_1e3_w_entropy_5e4_t08_grpo_step_10"
