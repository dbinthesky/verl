...
run_training() {
    ...
    python3 -m recipe.dapo.main_dapo \
        ...
        custom_reward_function.name=fabricate_aio_qwen3_8b_respondent_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/fabricate_qa.py" \
        +custom_valid_reward_function.name=fabricate_aio_qwen3_8b_respondent_compute_score_valid \
