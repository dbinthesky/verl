...
setup_path() {
    ...
    # BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/archived/fabricate_aio_distillv16_s3_roll16_bsz32_dapo_wo_kl_coef_wo_entropy_t08_solver_qwq_bo8_grpo_step_60"
    BASE_MODEL_PATH="fabricate_aio_v18_0730_2025-07-30_roll20_64_dapo_kl_coef_0_wo_entropy_t0.85_fabricate_aio_train_0730_step_30"
