...
setup_path() {
    ...
    TRAIN_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/doc2query/doc2query_question_refine_train"
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/doc2query/doc2query_question_refine_test"

    experiment_name="qwen_25-14b_question_refine-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_question_refine"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/qwen_25-14b_question_refine/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        custom_reward_function.path="${CUSTOM_CODE_DIR}/rewards/pt_mine.py" \
        custom_reward_function.name=qwq_longcot_question_refine_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/pt_mine.py" \
        +custom_valid_reward_function.name=qwq_longcot_question_refine_compute_score_valid \
