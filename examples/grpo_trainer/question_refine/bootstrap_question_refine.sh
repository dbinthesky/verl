...
JOB_NAME="qwen_25-14b_question_refine"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/question_refine/run_qwen2_5-14b_question_refine.sh"
