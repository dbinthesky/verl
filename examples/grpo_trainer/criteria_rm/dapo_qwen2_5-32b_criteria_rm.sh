...
setup_path() {
    ...
    TRAIN_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/criteria_rm/criteria_rm_recall_v2_dapo_math_17k_bo32.parquet"
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/criteria_rm/criteria_rm_recall_v2_aime_2024_2025_bo64.parquet"
    
    experiment_name="criteria_rm_32b_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_dapo_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}"
