...
setup_path() {
    ...
    KL_LOSS_COEF="0"
    TEMPERATURE="1.2"
    TRAIN_DATA_NAME="dapo_math_sat_sandbox_xml_cot_stage2_pass1_2@8"
    ...
    experiment_name="xml_cot_v16_0726_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_dapo_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}_${TRAIN_DATA_NAME}"
