...
JOB_NAME="verl-grpo-qwen2_5-7b_fabricate_qa_2024_0320_train_roll128"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/run_qwen2_5-7b_fabricate_qa_roll128_0320.sh"
