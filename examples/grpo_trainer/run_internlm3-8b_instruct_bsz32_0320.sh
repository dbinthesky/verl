...
setup_path() {
    ...
    BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/internlm3-8b_instruct-dlc-2025-03-18-02-17-21/2025-03-18/02-17-21/global_step_600/actor/huggingface"
...
verl/examples/grpo_trainer/run_internlm3-8b_instruct_bsz32_0319.sh
        sleep 10
        run_training "$@"
    fi
