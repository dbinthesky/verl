...
JOB_NAME="internlm_3-8b_pretrain_annotate"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/pretrain_annotate/run_internlm_3-8b_pretrain_annotate.sh"
