...
setup_path() {
    ...
    TRAIN_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/pretrain_rl/nv-nemotron-cc-medium_100w_annotation_task_v1"
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/pretrain_rl/pdf_2025_v1_zh_en_4k_annotation_task_test"

    experiment_name="internlm3-8b_pretrain_annotation_v1-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_internlm_pretrain_annotation"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/internlm_3-8b_pretrain_annotation/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        custom_reward_function.name=cot_pretrain_annotation_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/rm_w_criteria.py" \
        +custom_valid_reward_function.name=cot_pretrain_annotation_compute_score_valid \
