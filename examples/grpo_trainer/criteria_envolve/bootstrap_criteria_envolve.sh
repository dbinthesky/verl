...
JOB_NAME="qwen2_5-7b_qwq_criteria_envolve_hard"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/criteria_envolve/run_qwen2_5-7b_qwq_criteria_envolve_hard.sh"
