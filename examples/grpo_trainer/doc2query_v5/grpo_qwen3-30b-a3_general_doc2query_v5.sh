...
setup_path() {
    ...
    experiment_name="doc2query_v5_30b_a3_think_general_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}_agg-loss-token-mean"
