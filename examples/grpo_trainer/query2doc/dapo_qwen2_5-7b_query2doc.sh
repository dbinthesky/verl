...
setup_path() {
    ...
    # BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/guoxu/hf_hub/models/models--deepseek-ai--DeepSeek-R1-Distill-Qwen-7B/snapshots/6602cadec947dbb53e64f3d8d6425320b2197247" # [PLACEHOLDER]
    ...
    BASE_MODEL_PATH="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/archived/query2doc_7b_2025-08-30_roll16_64_dapo_kl_coef_0_wo_entropy_t1.0_step_30"
    TRAIN_DATA='["/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index0.parquet","/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index1.parquet", "/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index2.parquet", "/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index3.parquet", "/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index4.parquet", "/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_train/index5.parquet"]' # [PLACEHOLDER]
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/query2doc/query2doc_inputs_test.parquet" # [PLACEHOLDER]
    
    experiment_name="query2doc_7b_${YYMMDD}_roll${ROLLOUT_N}_${TRAIN_BSZ}_dapo_kl_coef_${KL_LOSS_COEF}_wo_entropy_t${TEMPERATURE}" # [PLACEHOLDER]
    project_name="query2doc" # [PLACEHOLDER]
    
    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/query2doc/${experiment_name}/" # [PLACEHOLDER]
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    custom_reward_function.path="${CUSTOM_CODE_DIR}/rewards/self_taught.py" \
    custom_reward_function.name=query2doc_compute_score_train \
    +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/self_taught.py" \
    +custom_valid_reward_function.name=query2doc_compute_score_valid \
