...
setup_path() {
    ...
    TRAIN_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/pretrain_mine/reason_pretrain_v3_8k_train_0503"
    VAL_DATA="/cpfs01/shared/llm_ddd/tongjian/rl/pretrain_mining/reason_pretrain_v3_8k_test.parquet"

    experiment_name="internlm3-8b_pretrain_mine-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_internlm_pretrain_mine"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/internlm_3-8b_pretrain_mine/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
...
run_training() {
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        custom_reward_function.name=qwq_longcot_pretrain_mining_compute_score_train \
        +custom_valid_reward_function.path="${CUSTOM_CODE_DIR}/rewards/pt_mine.py" \
        +custom_valid_reward_function.name=qwq_longcot_pretrain_mining_compute_score_valid \
