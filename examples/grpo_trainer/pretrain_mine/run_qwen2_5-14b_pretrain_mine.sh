...
setup_path() {
    ...
    experiment_name="qwen_25-14b_pretrain_mine-dlc-${YYMMDD}-${HHMMSS}"
    project_name="verl_grpo_internlm_pretrain_mine"

    OUTPUT_DIR="/cpfs01/shared/llm_ddd/tongjian/ckpts/datareview_rl_test/verl/grpo/qwen_25-14b_pretrain_mine/${experiment_name}/${YYMMDD}/${HHMMSS}"
    mkdir -p "${OUTPUT_DIR}"
}
setup_path
