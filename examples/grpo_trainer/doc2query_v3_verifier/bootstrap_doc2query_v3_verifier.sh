...
JOB_NAME="doc2query_v3_verifier"
PYARGS="${@:3}"
...
RUN_CMD="bash /cpfs01/shared/llm_ddd/tongjian/verl/examples/grpo_trainer/doc2query_v3_verifier/dapo_qwen2_5-32b_doc2query_v3_verifier.sh"
